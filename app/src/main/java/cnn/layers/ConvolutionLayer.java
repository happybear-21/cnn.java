...
import static cnn.utils.Matrix.add;
import static cnn.utils.Matrix.multiply;
...
public class ConvolutionLayer extends Layer{
    ...
    public void backPropagation(List<double[][]> dLdO) {
        ...
        List<double[][]> dLdOPreviousLayers = new ArrayList<>();
        ...
        for (int i = 0; i < _lastInput.size(); i++) {
            ...
            dLdOPreviousLayers.add(errorForInput);
        }
        ...
        if (_previousLayer != null) {
            _previousLayer.backPropagation(dLdOPreviousLayers);
        }
    }
